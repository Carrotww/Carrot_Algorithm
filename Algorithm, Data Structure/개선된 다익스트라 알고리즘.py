# https://techblog-history-younghunjo1.tistory.com/247?category=1014800
# 최단 경로 알고리즘
# 구현 팁
# 1. 출발 노드를 선정
# 2. 최단 거리 테이블을 초기화( 최단 거리를 기록할 테이블을 정의하고 )
# 3. 현재 노드에서 다른 노드로 갈 때의 간선 비용을 계산하여 최단 거리 테이블을 업데이트 함
